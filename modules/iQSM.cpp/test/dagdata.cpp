...
namespace tests {
    void dagdata_define() {
        ...
        auto dag = DagState::define<Element, Molecule, Atom>();
        ...
        EXPECT_TRUE(atom.depends_from.contains(Aspect<Molecule>::typeId));
        ...
        const auto& body = dag->aspects.at(Aspect<Molecule>::typeId);
