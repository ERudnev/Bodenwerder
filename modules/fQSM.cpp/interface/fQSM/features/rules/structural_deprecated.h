...
namespace fqsm::features::reflexes_deprecated {
...
namespace fqsm::features::reactions::rules::structural_deprecated {

    using fqsm::features::reflexes_deprecated::ComponentMissing;
