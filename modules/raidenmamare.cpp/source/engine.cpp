...
namespace rmmr {
    ...
    void Engine::prepareResources() {
        ...
        const auto lit_textured_alpha_shader = with<Assets>::add_shader_loader(main, assets, Unit::Quantum{.manager = assets, .name = "lit_textured_alpha_shader", .library = "rmmr"}, resource::shader::Asset::Quantum{}, resource::shader::Loader::Quantum{.vertex = "shaders/litTextured.vert.glsl", .fragment = "shaders/litTexturedAlpha.frag.glsl"});
        ...
        resources.material.ambient = with<Assets>::add_material(main, assets, Unit::Quantum{.manager = assets, .name = "ambient_material", .library = "rmmr"}, resource::builders::material::MaterialPresets::ambient(ambient_shader, shadow_depth_shader), resource::material::Composer::Quantum{});
        resources.material.lit = with<Assets>::add_material(main, assets, Unit::Quantum{.manager = assets, .name = "lit_material", .library = "rmmr"}, resource::builders::material::MaterialPresets::lit(lit_shader, shadow_depth_shader), resource::material::Composer::Quantum{});
        resources.material.debugLitTextured.push_back(with<Assets>::add_material(main, assets, Unit::Quantum{.manager = assets, .name = "lit_textured_debug01", .library = "rmmr"}, resource::builders::material::MaterialPresets::litTextured(lit_textured_shader, resources.texture.debug[0], shadow_depth_shader), resource::material::Composer::Quantum{}));
        resources.material.debugLitTextured.push_back(with<Assets>::add_material(main, assets, Unit::Quantum{.manager = assets, .name = "lit_textured_debug02", .library = "rmmr"}, resource::builders::material::MaterialPresets::litTextured(lit_textured_shader, resources.texture.debug[1], shadow_depth_shader), resource::material::Composer::Quantum{}));
        resources.material.debugLitTextured.push_back(with<Assets>::add_material(main, assets, Unit::Quantum{.manager = assets, .name = "lit_textured_debug03", .library = "rmmr"}, resource::builders::material::MaterialPresets::litTextured(lit_textured_shader, resources.texture.debug[2], shadow_depth_shader), resource::material::Composer::Quantum{}));
        resources.material.debugLitTextured.push_back(with<Assets>::add_material(main, assets, Unit::Quantum{.manager = assets, .name = "lit_textured_debug04", .library = "rmmr"}, resource::builders::material::MaterialPresets::litTextured(lit_textured_shader, resources.texture.debug[3], shadow_depth_shader), resource::material::Composer::Quantum{}));
        resources.material.litTexturedAlpha = with<Assets>::add_material(main, assets, Unit::Quantum{.manager = assets, .name = "lit_textured_alpha_ring", .library = "rmmr"}, resource::builders::material::MaterialPresets::litTexturedTransparent(lit_textured_alpha_shader, *resources.texture.whiteRing), resource::material::Composer::Quantum{});
