    ...
    namespace {
        ...
        Schema engineDomain() {
            static const Schema once = ask::schema::merge({
                ...
                ask::schema::aspect<resource::TexpackRuntime_group>(),
                ask::schema::aspect<resource::Texture3arrayRuntime_group>(),
                ...
                ask::schema::aspect<resource::texpack::Pack>(),
                ask::schema::aspect<resource::texpack::LoaderCatalog>(),
                ask::schema::aspect<resource::texpack::Runtime>(),
                ask::schema::aspect<resource::texture3array::Asset>(),
                ask::schema::aspect<resource::texture3array::Runtime>(),
