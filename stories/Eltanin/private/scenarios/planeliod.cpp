...
namespace eltanin::scenario {
    ...
    void Planeliod::populate(Writing context, rmmr::system::Device::Id device) {
        ...
        locality::geo::Planetoid::place(context, device, Pose::from({0,0,0}, HPB{0.0f, 0.0f, 0.0f}), locality::geo::Planetoid::Look{.seed = 7, .radius = 10000.0f, .maxRelief = 80.0f, .surfaceAcceleration = 4.0f, .tectonic = 0.015f, .atmosphere = {.radius = 11400.0f, .seaDensity = 1000.0f, .kerman = 1000.0f, .day = RGB{0.42f, 0.62f, 1.00f}}});
    }
