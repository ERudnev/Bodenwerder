...
const vector<Mineral>& Mineral::table() {
    ...
    static const vector<Mineral> table{
        ...
        Mineral{.name = "Iron", .density = 7.87f, .scale = 0.32f, .albedo = rgb(212, 96, 36), .sinter = rgb(255, 168, 64), .roughness = 0.40f, .metalness = 0.55f, .hardness = 4.0f, .meltKelvin = 1811.0f, .tintKelvin = 800.0f, .glowKelvin = 1200.0f, .sootMul = 0.06f},
