...
void main() {
    ...
    // Keep = cohesion/life opacity; heat eats keep (glowing melt). Mask: below threshold discard, above fade.
    float keep = actorAlbedoOpacity.a * (1.0 - 0.85 * smoothstep(1400.0, 2800.0, kelvin));
    if (actorHeat.w >= 0.0) {
