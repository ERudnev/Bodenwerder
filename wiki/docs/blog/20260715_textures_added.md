...
В `rmmr` добавлен первый полноценный texture pipeline. Входной точкой был драфт `resources/texture.q1`. Дальше работа пошла по двум зафиксированным условиям:
